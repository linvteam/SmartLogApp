...
export class EventGroupingComponent {
    ...
    /**
     * Metodo che gestisce il submit del form, comunica la log manipulation service il nuovo log manipulator. Se il numero di gruppi specificato � 0 verr� impostato il manipulator di default
     */
